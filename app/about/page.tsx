...
export const metadata: Metadata = {
  title: "About ",
  description:
    "Learn about Rizwan Hassan, AI automation expert from Pakistan specializing in RAG systems, intelligent agents, and workflow automation.",
}
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <div className="aspect-square rounded-2xl overflow-hidden bg-gradient-to-br from-blue-100 to-purple-100 dark:from-blue-900/20 dark:to-purple-900/20">
                  <img
                    src="new.jpg"
                    alt="Rizwan Hassan - AI Automation Expert"
